...
const init = async () =>
{
	...
	await createCustomer("gerald");
	await createCustomer("kaydian");
	await createCustomer("tonique");
	await createCustomer("foday");

	await createRestaurant("tropical");
	await createRestaurant("panda express");
	await createRestaurant("big fanta");
